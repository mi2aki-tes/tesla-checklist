...
export const CHECKLIST_ITEMS: ChecklistItemType[] = [
  ...
  { id: "tech_6", category: "③ ソフトウェア・機能", title: "グローブボックスの開閉", description: "モニターからの操作で開くか" },
  ...
  // 5. 書類・付属品
  { id: "doc_1", category: "⑤ 書類・付属品", title: "車検証と取扱説明書", description: "グローブボックスやトランク内を確認" },
  ...
  { id: "doc_5", category: "⑤ 書類・付属品", title: "USBドライブ（事前挿入）", description: "ダッシュカム用のUSBが刺さっているか" },
